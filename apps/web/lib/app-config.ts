...
export const MACHINES = [
  ...
  { id: "lying-triceps-extension", name: "라잉트라이셉스익스텐션", category: "arms", muscle: "삼두" },
  ...
  { id: "cable-arm-pulldown", name: "케이블 암풀다운", category: "back", muscle: "광배근" },
...
const MACHINE_VISUAL_MAP: Record<MachineId, MachineVisualKey> = {
  ...
  "ab-wheel": "core",
  "cable-arm-pulldown": "latPulldown",
